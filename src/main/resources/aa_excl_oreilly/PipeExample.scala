...
object PipeExample {
  def main(args: Array[String]) {
    ...
    val sc =
      new SparkContext(master, "PipeExample", System.getenv("SPARK_HOME"))
    ...
    val distScript =
      "/home/holden/repos/learning-spark-examples/src/R/finddistance.R"
    sc.addFile(distScript)

    val piped =
      rdd.pipe(Seq(SparkFiles.get(distScript)), Map("SEPARATOR" -> ","))
