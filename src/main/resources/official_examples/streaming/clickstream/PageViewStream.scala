...
package official_examples.streaming.clickstream

import official_examples.streaming.StreamingExamples
 ...
 * `$ bin/run-example official_examples.streaming.clickstream.PageViewGenerator 44444 10`
 * To process the generated stream
 * `$ bin/run-example \
 *    official_examples.streaming.clickstream.PageViewStream errorRatePerZipCode localhost 44444`
 */
// scalastyle:on
