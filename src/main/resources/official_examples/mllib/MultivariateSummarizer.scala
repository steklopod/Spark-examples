...
package official_examples.mllib
 ...
 * {{{
 * bin/run-example official_examples.mllib.MultivariateSummarizer
 * }}}
  ...
  def main(args: Array[String]) {
    ...
    val parser = new OptionParser[Params]("MultivariateSummarizer") {
      ...
      note(
        ...
        |
        | bin/spark-submit --class official_examples.mllib.MultivariateSummarizer \
