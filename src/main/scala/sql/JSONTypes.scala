...
object JSONTypes {
  def main(args: Array[String]) {
    ...
    val textConflict = spark.sparkContext.parallelize(
      Seq("{\"key\":42}", "{\"key\":\"hello\"}", "{\"key\":false}"),
      4)
